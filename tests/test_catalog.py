...
class CatalogTests(unittest.TestCase):
    ...
    def test_required_fields_and_unique_ids_and_links(self):
        ...
        self.assertEqual(len(self.books), 38)
    ...
    def test_all_reading_books_use_approved_thai_titles(self):
        expected = {
            ...
            "grok-bot-cli-usage-router-manual": "ใช้ Grok Bot ให้คุ้มกว่าเดิม",
            "codex-claude-shared-project-folder-manual": "One Project. Any AI.",
            "what-i-do": "งานของผม",
            "grok-bot-interactive-manual": "ใช้ Grok Bot อย่างมืออาชีพ",
            "hermes-bot-mode-interactive-manual": "Hermes Bot Mode",
            "podcast-visual-storyboard-ai-prompting": "Podcast Visual Storyboard",
            "human-ai-communication-framework": "Human–AI Communication Framework",
