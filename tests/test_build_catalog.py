...
class HomepageBuildTests(unittest.TestCase):
    ...
    def test_coffee_theme_is_loaded_only_by_the_reading_collection(self):
        ...
        self.assertIn('href="assets/css/reading-library.css?v=reading-cover-hover-v13"', reading)
        self.assertIn('href="assets/css/reading-library.css?v=reading-cover-hover-v13"', self.html)
        self.assertIn('src="assets/js/library.js?v=reading-cover-hover-v13"', reading)
        self.assertIn('src="assets/js/library.js?v=reading-cover-hover-v13"', self.html)
