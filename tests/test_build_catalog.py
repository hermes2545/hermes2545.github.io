...
class HomepageBuildTests(unittest.TestCase):
    ...
    def test_reading_book_cover_uses_stable_css_3d_front_cover_peek(self):
        ...
        self.assertNotIn("border-radius: 1px 6px 6px 1px;", stylesheet)
        self.assertNotIn("border-radius: 1px 3px 3px 1px;", stylesheet)
    ...
    def test_coffee_theme_is_loaded_only_by_the_reading_collection(self):
        ...
        self.assertIn('href="assets/css/reading-library.css?v=reading-cover-hover-v10"', reading)
        self.assertIn('href="assets/css/reading-library.css?v=reading-cover-hover-v10"', self.html)
        self.assertIn('src="assets/js/library.js?v=reading-cover-hover-v10"', reading)
        self.assertIn('src="assets/js/library.js?v=reading-cover-hover-v10"', self.html)
