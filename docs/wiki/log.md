...
- Added the third generated collection **App Shelf** with three source-provenance catalog entries from `p2544/battle-tank`, `p2544/bakery-center`, and `p2544/loderunner`; preserved the two single-file apps byte-for-byte, imported only the required Lode Runner runtime behind a stable wrapper, and designed each shelf item as a content-specific 3.5-inch diskette label in a Pantip Plaza 1990s software-floor theme.
